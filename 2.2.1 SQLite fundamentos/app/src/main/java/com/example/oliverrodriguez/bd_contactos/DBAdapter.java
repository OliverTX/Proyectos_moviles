...
/**
 * Created by oliverrodriguez on 18/09/17.
 */
...
public class DBAdapter {
    ...
    static final String DATABASE_NAME = "MyDB"; static final String DATABASE_TABLE = "contacts"; static final int DATABASE_VERSION = 1;
